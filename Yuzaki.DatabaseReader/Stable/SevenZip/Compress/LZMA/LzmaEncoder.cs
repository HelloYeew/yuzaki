    ...
    public class Encoder : ICoder, ISetCoderProperties, IWriteCoderProperties
	{
		...
		class LiteralEncoder
		{
			public struct Encoder2
			{
				...
				public void Encode(global::Yuzaki.DatabaseReader.Stable.SevenZip.Compress.RangeCoder.Encoder rangeEncoder, byte symbol)
				{
					uint context = 1;
					for (int i = 7; i >= 0; i--)
					{
				...
				public void EncodeMatched(global::Yuzaki.DatabaseReader.Stable.SevenZip.Compress.RangeCoder.Encoder rangeEncoder, byte matchByte, byte symbol)
				{
					uint context = 1;
					bool same = true;
					for (int i = 7; i >= 0; i--)
	    ...
	    class LenEncoder
	    {
	        ...
	        public void Encode(global::Yuzaki.DatabaseReader.Stable.SevenZip.Compress.RangeCoder.Encoder rangeEncoder, UInt32 symbol, UInt32 posState)
	        {
	    ...
	    class LenPriceTableEncoder : LenEncoder
		{
			...
			public new void Encode(global::Yuzaki.DatabaseReader.Stable.SevenZip.Compress.RangeCoder.Encoder rangeEncoder, UInt32 symbol, UInt32 posState)
			{
		...
		global::Yuzaki.DatabaseReader.Stable.SevenZip.Compress.RangeCoder.Encoder _rangeEncoder = new global::Yuzaki.DatabaseReader.Stable.SevenZip.Compress.RangeCoder.Encoder();
